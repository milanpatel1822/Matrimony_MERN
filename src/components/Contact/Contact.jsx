...
export default function Contact() {
    return (
        <>
            <div class="font-poppins max-w-6xl mx-auto relative bg-white rounded-lg py-6">
                <div class="grid lg:grid-cols-3 items-center">
                    ...
                    <div class="lg:col-span-2 bg-purple-700 rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
                        ...
                        <form>
                            <div class="max-w-md mx-auto space-y-3">
                                ...
                                <button type='button'
                                    class="text-gray-800 w-full relative bg-pink-400 hover:bg-pink-500 font-semibold rounded-lg text-sm px-6 py-3 !mt-6">
